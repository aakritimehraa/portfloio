...
' name='Lofi  Studio' link='https://lofi-studio.netlify.app' g='https://github.com/aakritimehraa/react-lofi' tags={['React' , 'redux' , 'netlify']} image={lofi}/>
        ...
        <Projectboxrev description='Tracks and manages income and expense and visualizes with charts made using react-redux' name='Xpense Tracker' link='https://expense-tracker-by-aakriti.netlify.app/' g='https://github.com/aakritimehraa/expensetracker' tags={['React' , 'redux' , 'charts.js']} image={expense}/>
